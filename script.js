...
const translations = {
  pt: {
    ...
    "instruction-1":
      "As perguntas baseiam-se em edições anteriores do exame <strong>OCI Foundations Associate (1Z0-1085-25)</strong>.",
    "instruction-2":
      "Reserve <strong>60 minutos</strong> sem interrupções para completar as 40 perguntas.",
    "instruction-3":
      "Procure um <strong>ambiente tranquilo</strong> e certifique-se de ter uma boa ligação à Internet.",
    "instruction-4":
      "Realize a simulação <strong>mais de uma vez</strong> para ganhar confiança e familiarizar-se com a ordem aleatória.",
  ...
  en: {
    ...
    "instruction-1":
      "The questions are based on previous editions of the <strong>OCI Foundations Associate (1Z0-1085-25)</strong> exam.",
    "instruction-2":
      "Set aside <strong>60 minutes</strong> without interruptions to complete the 40 questions.",
    "instruction-3":
      "Find a <strong>quiet environment</strong> and ensure you have a good internet connection.",
    "instruction-4":
      "Complete the simulation <strong>more than once</strong> to gain confidence and familiarize yourself with the random order.",
...
const rawQuestionsPT = [
  ...
  },
  {
    ...
    options: ["NAT Gateway", "Service Gateway", "DRG", "Internet Gateway"],
    correct: 1,
  },
  {
  ...
  },
  {
    ...
    options: ["Fault Domains", "Data Guard", "GoldenGate", "RAC"],
    correct: 0,
  },
  {
  ...
  },
  {
    ...
    options: ["Budgets", "Quotas", "Usage Reports", "Cost Analysis"],
    correct: 3,
  },
  {
  ...
  },
  {
    ...
    options: ["File Storage", "Block Volume", "Object Storage", "Local NVMe"],
    correct: 3,
  },
  {
...
const rawQuestionsEN = [
  ...
  },
  {
    ...
    options: ["On the client", "On the HSM", "On the cloud", "On the server"],
    correct: 1,
  },
  {
  ...
  },
  {
    ...
    options: ["Action Verb", "Resource-type", "Encryption", "Location"],
    correct: 2,
  },
  {
  ...
  },
  {
    ...
    options: ["Principal", "Action", "Resource", "Effect"],
    correct: 0,
  },
  {
...
function selectLanguage(lang) {
  ...
  gtag("event", "seleccionar_idioma", {
    idioma: lang === "pt" ? "portugues" : "ingles", // Ajustado para PT/EN
  });
...
function showQuestion() {
  ...
  const pct =
    total > 0 ? Math.round(((currentQuestionIndex + 1) / total) * 100) : 0;
...
function showResults() {
  ...
  gtag("event", "resultado_simulado", {
    status: passed ? "aprobado" : "reprobado", // Usa la variable 'passed'
    puntaje: percent, // Usa el porcentaje real
    idioma_examen: currentLanguage, // Captura si fue 'es' o 'en'
  });
  ...
  for (let i = 0; i < total; i++) {
    ...
    q.options.forEach((optText, idx) => {
      ...
      if (idx === userIdx && userIdx !== q.correct)
        opt.classList.add("review-option--wrong");
